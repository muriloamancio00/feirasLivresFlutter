...
import 'view_delet_feirante_model.dart';
export 'view_delet_feirante_model.dart';

class ViewDeletFeiranteWidget extends StatefulWidget {
  const ViewDeletFeiranteWidget({
    super.key,
    int? acao,
  })  : acao = acao ?? 1;
  ...
  @override
  _ViewDeletFeiranteWidgetState createState() =>
      _ViewDeletFeiranteWidgetState();
}

class _ViewDeletFeiranteWidgetState extends State<ViewDeletFeiranteWidget> {
  late ViewDeletFeiranteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewDeletFeiranteModel());
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    FutureBuilder<List<FeiranteRow>>(
                      future: (_model.requestCompleter ??=
                              Completer<List<FeiranteRow>>()
                                ..complete(FeiranteTable().queryRows(
                                  queryFn: (q) => q,
                                )))
                          .future,
