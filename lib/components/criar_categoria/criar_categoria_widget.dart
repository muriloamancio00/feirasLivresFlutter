...
import 'criar_categoria_model.dart';
export 'criar_categoria_model.dart';

class CriarCategoriaWidget extends StatefulWidget {
  const CriarCategoriaWidget({super.key});

  @override
  _CriarCategoriaWidgetState createState() => _CriarCategoriaWidgetState();
}

class _CriarCategoriaWidgetState extends State<CriarCategoriaWidget>
    with TickerProviderStateMixin {
  late CriarCategoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarCategoriaModel());
