                ...
                child: Container(
                  ...
                  child: FutureBuilder<List<CategoriasRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CategoriasRow> dpCategoriaCategoriasRowList =
                          snapshot.data!;
                      return FlutterFlowDropDown<int>(
                        controller: _model.dpCategoriaValueController ??=
                            FormFieldController<int>(null),
                        options: List<int>.from(dpCategoriaCategoriasRowList
                            .map((e) => valueOrDefault<int>(
                                  e.id,
                                  0,
                                ))
                            .toList()),
                        optionLabels: dpCategoriaCategoriasRowList
                            ...
                            .toList(),
                        onChanged: (val) =>
                            setState(() => _model.dpCategoriaValue = val),
                        width: 300.0,
                        height: 50.0,
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  style: FlutterFlowTheme.of(context).bodyMedium,
                  validator:
                      _model.txtPrecoControllerValidator.asValidator(context),
                ),
              ),
            ],
          ),
            ...
            child: FFButtonWidget(
              onPressed: () async {
                await ProdutosTable().insert({
                  ...
                  'categoria_id': _model.dpCategoriaValue,
                  'preco': double.tryParse(_model.txtPrecoController.text),
                });
                await showDialog(
                  context: context,
