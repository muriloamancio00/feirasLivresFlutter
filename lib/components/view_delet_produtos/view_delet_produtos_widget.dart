...
import 'view_delet_produtos_model.dart';
export 'view_delet_produtos_model.dart';

class ViewDeletProdutosWidget extends StatefulWidget {
  const ViewDeletProdutosWidget({
    super.key,
    int? acao,
  })  : acao = acao ?? 1;
  ...
  @override
  _ViewDeletProdutosWidgetState createState() =>
      _ViewDeletProdutosWidgetState();
}

class _ViewDeletProdutosWidgetState extends State<ViewDeletProdutosWidget> {
  late ViewDeletProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewDeletProdutosModel());
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    FutureBuilder<List<ViewProdutoCategoriaRow>>(
                      future: (_model.requestCompleter ??= Completer<
                              List<ViewProdutoCategoriaRow>>()
                            ..complete(ViewProdutoCategoriaTable().queryRows(
                              queryFn: (q) => q,
                            )))
                          .future,
                      builder: (context, snapshot) {
                        ...
                        List<ViewProdutoCategoriaRow>
                            listViewViewProdutoCategoriaRowList =
                            snapshot.data!;
                                            ...
                                            child: Container(
                                              ...
                                              child: Image.network(
                                                valueOrDefault<String>(
                                                  listViewViewProdutoCategoriaRow
                                                      .fotoProduto,
                                                  'https://img.elo7.com.br/product/original/38E749F/painel-redondo-festa-lua-cheia-c-elastico-1-30x1-30.jpg',
                                                ),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(6.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Cateoria: ${listViewViewProdutoCategoriaRow.nomeCategoria}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
