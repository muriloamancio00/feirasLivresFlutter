...
import 'criar_feira_model.dart';
export 'criar_feira_model.dart';

class CriarFeiraWidget extends StatefulWidget {
  const CriarFeiraWidget({super.key});

  @override
  _CriarFeiraWidgetState createState() => _CriarFeiraWidgetState();
}

class _CriarFeiraWidgetState extends State<CriarFeiraWidget>
    with TickerProviderStateMixin {
  late CriarFeiraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarFeiraModel());
